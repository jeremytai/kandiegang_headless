    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-3xl mx-auto px-6 pb-24 md:pb-32">
        <section id="responsible" className={SECTION_SPACING}>
          ...
          <p className={PARAGRAPH_CLASS}>
            <strong>Entry in the commercial register</strong>
            <br />
          ...
          <p className={PARAGRAPH_CLASS}>Jeremy Tai Abbett</p>
        </section>

        <section id="vsbg" className={SECTION_SPACING}>
          <h2 className={HEADING_CLASS}>Information according to § 36 VSBG</h2>
          <p className={PARAGRAPH_CLASS}>
            The EU Commission has created a platform for online dispute resolution (ODR platform)
            between merchants and consumers. This ODR platform is available via the following link:
          </p>
          <p className={PARAGRAPH_CLASS}>
            <a
