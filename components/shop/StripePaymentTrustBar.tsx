...
const DEFAULT_MICROCOPY = 'Secure checkout. Free shipping on orders over €99 within the EU.';
...
export const StripePaymentTrustBar: React.FC<StripePaymentTrustBarProps> = ({
  ...
  return <div className="flex items-center justify-start min-h-[24px]">{content}</div>;
};
