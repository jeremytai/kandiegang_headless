    ...
    <div className="overflow-hidden border-t border-secondary-current py-6 md:py-8">
      ...
      >
        <span className="max-w-[60ch] flex-1 pr-4">
          <p className="text-lg md:text-xl font-medium tracking-tight text-secondary-drift">{question}</p>
        </span>
        <span 
    ...
    <section id="faqs" className="bg-white">
      <div className="relative m-4 overflow-hidden rounded-xl bg-secondary-purple-rain p-6 md:m-6 md:p-8 lg:p-12">
        <div className="grid grid-cols-1 pt-10 pb-20 gap-12 lg:grid-cols-12 lg:gap-6 lg:items-start">
          <h2 className="text-left text-3xl font-light tracking-tight text-secondary-drift md:text-7xl lg:col-span-12 mb-12 md:mb-16">
        ...
        <div className="lg:col-span-7 self-start">
          <div className="w-full flex flex-col">
            <FAQItem 
              question="What is Kandie Gang?" 
              isOpen={openIndex === 0} 
              onClick={() => toggleIndex(0)}
            >
              <p className="mb-4">Kandie Gang is an inclusive cycling community originally started in 2019 as a small fixed-gear and cyclocross team and has since grown into a broader group that supports riders of all backgrounds, especially FLINTA* (women, non-binary, trans, intersex, agender) and BIPOC, to participate in cycling culture.</p>
            ...
            <FAQItem 
              question="How can I stay updated on Kandie Gang?" 
              isOpen={openIndex === 2} 
