...
export const IconLink: React.FC<IconProps> = ({ size = DEFAULT_SIZE, className = '' }) => (
  <svg
    ...
    aria-hidden
  >
    <path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" fill="none" />
    <path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" fill="none" />
  </svg>
);
...
export const IconKlarna: React.FC<IconProps> = ({ size = DEFAULT_SIZE, className = '' }) => (
  <svg
    ...
    aria-hidden
  >
    <rect x="3" y="6" width="18" height="12" rx="1.5" stroke="currentColor" strokeWidth="1.5" fill="none" />
    <path d="M8 10v4M12 10v4M16 10v4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);
...
export const IconBank: React.FC<IconProps> = ({ size = DEFAULT_SIZE, className = '' }) => (
  ...
  >
    ...
    <path d="M4 8v10M12 8v10M20 8v10M6 12h4M14 12h4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);
