...
const SUBSTACK_PUBLICATION = (
  import.meta as unknown as { env: { VITE_SUBSTACK_PUBLICATION?: string } }
).env.VITE_SUBSTACK_PUBLICATION?.trim();
              ...
              {embedUrl ? (
                ...
                <div className="flex flex-1 flex-col items-center justify-center gap-4 px-6 pb-10">
                  <p className="text-center text-slate-600">
                    ...
                    in your <code className="rounded bg-slate-100 px-1.5 py-0.5 text-sm">.env</code>{' '}
                    to your Substack publication URL.
                  </p>
                  {subscribeUrl && (
                    <a
                      href={subscribeUrl}
