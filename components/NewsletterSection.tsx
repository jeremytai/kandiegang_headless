...
export const NewsletterSection: React.FC = () => {
  ...
  return (
    <>
      <section
        className="relative my-4 grid h-[20vh] min-h-[110px] grid-cols-1 grid-rows-1 overflow-hidden rounded-xl bg-secondary-current md:my-6 md:h-[110px]"
      ...
      >
        <div className="relative z-10 col-span-1 col-start-1 row-start-1 flex flex-col items-center justify-center gap-1 p-6 md:flex-row md:gap-4">
          <h3 className="font-body text-center text-sm font-normal tracking-normal text-white md:text-base">
          ...
          <button
            ...
            className="group inline-flex flex-nowrap items-center justify-center gap-1.5 rounded-full border border-secondary-blush bg-transparent px-3.5 py-3 text-sm font-medium text-secondary-blush transition-colors hover:border-secondary-blush hover:bg-secondary-blush hover:text-white md:h-auto md:gap-2 md:text-base"
          ...
          >
            ...
            <span className="flex h-4 w-4 items-center justify-center rounded-full bg-secondary-blush/20 p-1 transition-colors group-hover:bg-white">
              <ArrowRight className="h-3 w-3 text-current" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
            </span>
          </button>
        </div>
      </section>
