/**
 * RideLevelsModal.tsx
 * Modal that shows the Ride Levels content. Same content as RideLevelsPage.
 */
...
export const RideLevelsModal: React.FC<RideLevelsModalProps> = ({ isOpen, onClose }) => {
  useEffect(() => {
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            role="dialog"
            aria-modal="true"
            aria-labelledby="ridelevels-modal-title"
          >
            <button
              type="button"
              onClick={onClose}
            ...
            <div className="flex flex-1 flex-col overflow-y-auto">
              <RideLevelsContent variant="modal" />
            </div>
          </motion.div>
        </>
      )}
