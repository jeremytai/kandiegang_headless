/**
 * WaiverModal.tsx
 * Modal that shows the Ride Waiver content. Same content as WaiverPage.
 */
...
export const WaiverModal: React.FC<WaiverModalProps> = ({ isOpen, onClose, onSignWaiver }) => {
  useEffect(() => {
        ...
        <>
          ...
          >
            ...
            <div className="flex flex-1 flex-col overflow-y-auto">
              <WaiverContent variant="modal" onSignWaiver={onSignWaiver} />
            </div>
          </motion.div>
        </>
      )}
